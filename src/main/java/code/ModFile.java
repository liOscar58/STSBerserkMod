...
public class ModFile implements
    ...
    public static final String modID = "STSBerserkMod"; //TODO: Change this.

    public static String makeID(String idText) {
        return modID + ":" + idText;
    }
    private static final Color cardColor = new Color(36f/255f, 36/255f, 36f/255f, 1f);
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(new CharacterFile(CharacterFile.characterStrings.NAMES[1], CharacterFile.Enums.Guts),
                CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT, CharacterFile.Enums.Guts);
    }
